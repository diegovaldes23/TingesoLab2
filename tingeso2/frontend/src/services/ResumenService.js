...
class ResumenService {
  ...
  getResumenes() {
    return axios.get('http://localhost:8080/resumenes/listar-resumenes')
  ...
  generarResumen(rut) {
    return axios.post('http://localhost:8080/resumenes/generar-resumen', new URLSearchParams({ rut }))
      .then(response => response.data)
